...
function buildEvent(raw: Record<string, unknown>, sourceMessage: string): EconomicEvent {
  return {
    ...
    workerPhone: raw.workerPhone || null,
    economicLabel: raw.economicLabel || raw.label || null,
    ...
    derivedCategory: raw.derivedCategory || raw.category || null,
    category: raw.category || raw.derivedCategory || null,
    amount: Number(raw.amount) || Number(raw.total) || null,
    currency: raw.currency || "ARS",
    date: raw.date || null,
    broadArea: raw.broadArea || raw.area || null,
    evidenceType: raw.evidenceType || null,
    commercialStatus: raw.commercialStatus || null,
    quotedAmount: Number(raw.quotedAmount) || null,
    startDate: raw.startDate || null,
    endDate: raw.endDate || null,
    estimatedDuration: raw.estimatedDuration || null,
    collaborators: Array.isArray(raw.collaborators) ? raw.collaborators : [],
    splitRule: raw.splitRule || null,
    netIncome: Number(raw.netIncome) || null,
    quantity: Number(raw.quantity) || null,
    unit: raw.unit || null,
    grossAmount: Number(raw.grossAmount) || null,
    costAmount: Number(raw.costAmount) || null,
    costDescription: raw.costDescription || null,
    deductionAmount: Number(raw.deductionAmount) || null,
    deductionDescription: raw.deductionDescription || null,
    location: typeof raw.location === "string" ? raw.location : raw.location?.address || raw.broadArea || raw.area || null,
    description: raw.description || raw.details || raw.detalle || null,
    pgOrExternalRef: raw.pgOrExternalRef || raw.reference || null,
    originChannel: raw.originChannel || "web",

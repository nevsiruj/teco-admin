...
<html lang="es">
  <head>
    ...
    <title>Ingreso Wofory</title>
    <style>
      :root{--bg:#f5f5f0;--panel:#fff;--text:#111827;--muted:#64748b;--brand:#1e1b4b;--border:#e5e7eb;--danger:#b91c1c}
      *{box-sizing:border-box}body{margin:0;min-height:100vh;display:grid;place-items:center;background:var(--bg);font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--text)}
      ...
      h1{margin:0;color:var(--brand);font-size:1.55rem;letter-spacing:.02em}p{margin:8px 0 22px;color:var(--muted);line-height:1.45}
      ...
      button{width:100%;border:0;border-radius:12px;background:var(--brand);color:white;padding:13px 16px;font:inherit;font-weight:800;cursor:pointer}
  ...
  <body>
    <main class="card">
      <h1>WOFORY</h1>
      <p>Ingresá para administrar el agente y revisar la actividad.</p>
      ${errorBlock}
